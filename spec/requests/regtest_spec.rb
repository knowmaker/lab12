...
describe 'Regtest' do
  ...
  it 'regtest' do
    ...
    @driver.find_element(:id, 'user_username').send_keys('av2004')
    @driver.find_element(:id, 'user_email').click
    @driver.find_element(:id, 'user_email').send_keys('av2004@gmail.ru')
    ...
    @driver.find_element(:id, 'email').send_keys('av2004@gmail.ru')
